...
export API_BASE_URL="http://33.235.218.92:22002/v1"
export API_KEY="dummy"
export MODEL_NAME="qwen3_vl_a22b"  # 或其他模型
export LLM_JUDGE_CONCURRENCY=16  # 可选，默认16
export LLM_JUDGE_TIMEOUT=60      # 可选，默认60秒
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal-TRIT-LLMJudge"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/NJUWorkspace/TRIT/MeiTuan/TRIT/dataset/Train/Qwen3/DAPO3K/STS/dapo3k_fr_ja_ko_pt_th_with_en_begin.parquet \
 ...
 trainer.task='sts-solo-language-filter-0114-llm-judge' \
 ...
 trainer.experiment_name=Rebuttal-TRIT-LLMJudge \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal-TRIT-LLMJudge \
 trainer.total_epochs=8 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-Rebuttal-TRIT-LLMJudge.log 
