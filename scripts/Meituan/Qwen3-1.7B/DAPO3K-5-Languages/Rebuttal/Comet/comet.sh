...
export COMET_SERVER_URL="http://33.235.1.181:8002"
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal-TRIT-Comet"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 trainer.task='sts-solo-language-filter-0114-comet' \
 ...
 trainer.experiment_name=Rebuttal-TRIT-Comet \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal-TRIT-Comet \
 trainer.total_epochs=6 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-Rebuttal-TRIT-Comet.log 
