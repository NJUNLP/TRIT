...
export REJECT_STAGE2_DATA=1
# export REJECT_STAGE3_DATA=1
export CHECK_REPETITION=1
export USE_MATH_LJX_FINAL=1
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal_MT_Reasoning_MT_TRIT_Reasoning"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 actor_rollout_ref.model.path=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal_MT_Reasoning_MT_TRIT/global_step_145/actor/huggingface \
 ...
 trainer.task='sts-solo-language-filter-0114' \
 ...
 trainer.experiment_name=Rebuttal_MT_Reasoning_MT_TRIT_Reasoning \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal_MT_Reasoning_MT_TRIT_Reasoning \
 trainer.total_epochs=7 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-Rebuttal_MT_Reasoning_MT_TRIT_Reasoning.log 
