...
export USE_EN_REASONING_REWARD=1
export CHECK_REPETITION=1
export USE_SLC_REWARD=1
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal-EN-Reasoning-TRIT"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/dataset/Train/Qwen3/DAPO3K/STS/dapo3k_fr_ja_ko_pt_th_with_en_begin.parquet \
 data.val_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/dataset/Test/MMATH/Qwen3/Without-Prefix/mmath_fr_ja_ko_pt_th_en_begin.parquet \
 ...
 trainer.task='sts-solo-language-filter-0128' \
 ...
 trainer.experiment_name=Rebuttal-EN-Reasoning-TRIT \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/Rebuttal-EN-Reasoning-TRIT \
 trainer.total_epochs=8 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-Rebuttal-EN-Reasoning-TRIT.log 
