...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_no_zero_repair_new"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Train/Qwen3/DAPO3K/STS/dapo3k_fr_ja_ko_pt_th_without_zero.parquet \
 data.val_files=["/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Test/PolyMATH/Qwen3/Medium/fr_ja_ko_pt_th.parquet","/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Test/PolyMATH/Qwen3/High/fr_ja_ko_pt_th.parquet"] \
 ...
 trainer.task='sts-solo-language-filter-padding' \
 ...
 trainer.experiment_name=sts_8k_no_zero_repair_new \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_no_zero_repair_new \
 trainer.total_epochs=10 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-sts_8k_no_zero_repair_new.log 
