...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/dataset/Train/Qwen3/DAPO3K/dapo3k_fr_ja_ko_pt_th_without_zero.parquet \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/baseline_8k_no_zero \
 trainer.total_epochs=10 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/logs/DAPO3K-5-Languages-Qwen3-1D7B-baseline_8k_no_zero.log 
