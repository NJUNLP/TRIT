...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_filter_repair_newest_repair"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 trainer.experiment_name=sts_8k_filter_repair_newest_repair \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_filter_repair_newest_repair \
 trainer.total_epochs=8 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-sts_8k_filter_repair_newest_repair.log 
