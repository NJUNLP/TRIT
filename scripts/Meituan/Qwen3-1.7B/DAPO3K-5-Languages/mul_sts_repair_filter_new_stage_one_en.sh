...
export STAGE_ONE_EN=1
export CHECK_REPETITION=1
export USE_MATH_LJX_FINAL=1
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/tensorboard_log/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_filter_repair_newest_stage_one_en"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 trainer.experiment_name=sts_8k_filter_repair_newest_stage_one_en \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_filter_repair_newest_stage_one_en \
 trainer.total_epochs=5 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-sts_8k_filter_repair_newest_stage_one_en.log 
