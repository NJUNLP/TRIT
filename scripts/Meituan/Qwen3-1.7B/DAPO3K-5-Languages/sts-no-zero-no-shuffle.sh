...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Train/Qwen3/DAPO3K/STS/dapo3k_no_shuffle_fr_ja_ko_pt_th_without_zero.parquet \
 ...
 trainer.experiment_name=sts_8k_no_zero_no_shuffle \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-1D7B/sts_8k_no_zero_no_shuffle \
 trainer.total_epochs=10 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-1D7B-sts_8k_no_zero_no_shuffle.log 
