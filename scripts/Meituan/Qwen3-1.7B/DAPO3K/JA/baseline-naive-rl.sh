...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/data/DAPO/dapo_3k_ja_baseline_without_prefix.parquet \
 data.val_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/data/math500_ja_question_ja_prompt_without_prefix.parquet \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/checkpoints/DAPO3K-Qwen3-1.7B-JA/ja_baselin_naive_rl-8192 \
 trainer.total_epochs=15 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/logs/DAPO3K-JA-ja_baselin_naive_rl-8192.log 
