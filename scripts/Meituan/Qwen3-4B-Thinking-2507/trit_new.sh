...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-4B-Thinking-2507/Rebuttal-Qwen3-4B-Thinking-2507-TRIT-bsz-32"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Train/Qwen3-4B-Thinking-2507/STS/dapo3k_fr_ja_ko_pt_th.parquet \
 data.val_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Test/MMATH/Qwen3/mmath_fr_ja_ko_pt_th_1_sample.parquet \
 ...
 actor_rollout_ref.model.path=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/SFT/SFT-Checkpoint/Qwen3-4B-Thinking-2507/DAPO3K-5-Language-Qwen3-1.7B-EN-Question \
 ...
 trainer.task='sts-solo-language-filter-0210' \
 ...
 trainer.save_freq=2 \
 trainer.test_freq=5 \
 trainer.project_name=DAPO3K-5-Languages-Qwen3-4B-Thinking-2507 \
 trainer.experiment_name=Rebuttal-Qwen3-4B-Thinking-2507-TRIT-bsz-128-32 \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-4B-Thinking-2507/Rebuttal-Qwen3-4B-Thinking-2507-TRIT-bsz-32 \
 trainer.total_epochs=6 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-4B-Thinking-2507-Rebuttal-Qwen3-4B-Thinking-2507-TRIT-bsz-32.log 
