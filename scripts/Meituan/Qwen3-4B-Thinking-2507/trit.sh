...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-Qwen3-4B-Thinking-2507/Rebuttal-Qwen3-4B-Thinking-2507-TRIT"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 trainer.experiment_name=Rebuttal-Qwen3-4B-Thinking-2507-TRIT \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-4B-Thinking-2507/Rebuttal-Qwen3-4B-Thinking-2507-TRIT \
 trainer.total_epochs=6 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-4B-Thinking-2507-Rebuttal-Qwen3-4B-Thinking-2507-TRIT.log 
