...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 actor_rollout_ref.model.path=/mnt/hdfs/zw04mlnn01/checkpoint/llm_platform/model/Qwen/Qwen3-4B/main \
 ...
 trainer.save_freq=5 \
 trainer.test_freq=5 \
 trainer.project_name=MATH8K-Qwen3-4B-JA \
 trainer.experiment_name=ja_baseline_8192 \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/checkpoints/MATH8K-Qwen3-4B-JA/ja_baseline-8192 \
 trainer.total_epochs=10 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/logs/MATH8K-Qwen3-4B-JA-ja_baseline-8192.log 
