...
export API_KEY="sk-bH-xK7rHsuiCN46lz5ocfA"
export TRANSLATION_MODEL_NAME="DeepSeek-V3.2-Exp"
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/tensorboard_log/DAPO3K-5-Languages-Qwen3-4B/sts_other_translation"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 trainer.task='sts-other-translate-solo' \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-Qwen3-4B/sts_other_translation \
 trainer.total_epochs=5 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-Qwen3-4B-sts_other_translation.log 
