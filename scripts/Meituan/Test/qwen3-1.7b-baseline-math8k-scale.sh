...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/data/math8k-ljx-qalign-deepseek-expand.parquet \
 ...
 trainer.experiment_name=ja_baseline_8192_scale \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/checkpoints/MATH8K-Qwen3-1.7B-JA/ja_baseline-8192_scale \
 trainer.total_epochs=10 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/logs/MATH8K-JA-ja_baseline-8192_scale.log 
