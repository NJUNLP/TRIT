...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/checkpoints/MATH8K-DeepSeek-R1-Distill-Qwen-1.5B-BN/bn_full_sft_sts_8192_new_1125 \
 trainer.total_epochs=5 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/logs/MATH8K-DeepSeek-R1-Distill-Qwen-1.5B-BN-bn_full_sft_sts_8192_new_1125.log 
