...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/tensorboard_log/MATH8K-Target-5-Languages-DeepSeek-Distill-1D5B/sts-8k-repair"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Train/DeepSeek-R1-Distill-Qwen-1.5B-DAPO3K-5-Language-Qwen3-1.7B-EN-Question-MATH8K-Target/STS/dapo3k_fr_ja_ko_pt_th.parquet \
 data.val_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Test/PolyMATH/DeepSeek-Distill/Medium/fr_ja_ko_pt_th.parquet \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/checkpoints/MATH8K-Target-5-Languages-DeepSeek-Distill-1D5B/sts-8k-repair \
 trainer.total_epochs=5 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/logs/MATH8K-Target-5-Languages-DeepSeek-Distill-1D5B-sts-8k-repair.log 
