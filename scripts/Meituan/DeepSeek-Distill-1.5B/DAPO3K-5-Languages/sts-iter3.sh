...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/FMG/liujunxiao03/tensorboard_log/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-iter3-new"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/dataset/Train/DeepSeek-Distill-1.5B-STS-Iter2/STS/dapo3k_fr_ja_ko_pt_th.parquet \
 ...
 actor_rollout_ref.model.path=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/checkpoints/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-iter2/global_step_232/actor/huggingface \
 ...
 trainer.task='sts-solo-language-filter' \
 ...
 trainer.experiment_name=sts-iter3-new \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-iter3-new \
 trainer.total_epochs=8 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-DeepSeek-Distill-1D5B-sts-iter3-new.log 
