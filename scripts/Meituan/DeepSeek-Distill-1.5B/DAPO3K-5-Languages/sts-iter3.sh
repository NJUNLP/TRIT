...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Train/DeepSeek-Distill-1.5B-STS-Iter2/STS/dapo3k_fr_ja_ko_pt_th.parquet \
 ...
 actor_rollout_ref.model.path=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/checkpoints/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-iter2/global_step_232/actor/huggingface \
