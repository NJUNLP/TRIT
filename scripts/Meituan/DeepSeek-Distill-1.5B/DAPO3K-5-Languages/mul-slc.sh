...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/dataset/Train/DeepSeek-Distill/DAPO3K/dapo3k_fr_ja_ko_pt_th_without_prefix.parquet \
 ...
 actor_rollout_ref.rollout.translation_sample_n=8 \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/slc-8k \
 trainer.total_epochs=10 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-DeepSeek-Distill-1D5B-slc-8k.log 
