...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/SvS-0918/tensorboard_log/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-new-8k-with-translation"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 trainer.experiment_name=sts-new-8k-with-translation \
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/checkpoints/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-new-8k-with-translation \
 trainer.total_epochs=5 2>&1 | tee /mnt/dolphinfs/ssd_pool/docker/user/hadoop-nlp-sh02/hadoop-aipnlp/FMG/liujunxiao03/logs/DAPO3K-5-Languages-DeepSeek-Distill-1D5B-sts-new-8k-with-translation.log 
