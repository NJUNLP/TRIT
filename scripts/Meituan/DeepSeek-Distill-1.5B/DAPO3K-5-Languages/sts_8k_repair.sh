...
# ================= tool setting =================
export TENSORBOARD_DIR="/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/tensorboard_log/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-8k-repair-new"
...
if [[ "$node_rank" -ne "0" ]]; then
 ...
 data.train_files=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/dataset/Train/DeepSeek-Distill/DAPO3K/STS/dapo3k_fr_ja_ko_pt_th.parquet \
 ...
 trainer.default_local_dir=/mnt/dolphinfs/ssd_pool/docker/user/hadoop-hldy-nlp/FMG/liujunxiao03/MeiTuan/TRIT/checkpoints/DAPO3K-5-Languages-DeepSeek-Distill-1D5B/sts-8k-repair-new \
