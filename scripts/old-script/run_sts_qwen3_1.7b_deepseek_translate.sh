...
export API_KEY="sk-q5H1DVsOg4Afd0z53s53cw"
...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-DeepSeek-translate"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.task='sts-deepseek-translate' \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-DeepSeek-translate \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-DeepSeek-translate \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-JA-StS-0.2-1.0-1.0-repair-DeepSeek-translate.log 


# bash /home/nfs05/liujx/GithubRepos/PCS/dpo/train.sh
