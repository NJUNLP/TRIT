...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-remove-three"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-remove-three \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-remove-three \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-JA-StS-0.2-1.0-1.0-repair-remove-three.log 



bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/run_sts_qwen3_1.7b-remove-stage-one.sh
# bash /home/nfs05/liujx/Inference/scripts/temp.sh
cd /home/nfs05/liujx/GithubRepos/verl
bash /home/nfs05/liujx/GithubRepos/verl/my_scripts/Qwen3-1.7B/JA/MATH/grpo_0.1_language_reward_ja_question_ja_prompt_ja_begin_math_ljx_same_with_sts_expand_qwen3_1.7b_8.sh
