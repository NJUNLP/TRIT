...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-remove-stage-one"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=/home/nfs05/liujx/GithubRepos/SvS-0918/data/math8k-ljx.parquet \
 ...
 actor_rollout_ref.model.path=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-only-stage-one/global_step_145/actor/huggingface \
 ...
 trainer.task='sts-remove-stage-one' \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-remove-stage-one \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-remove-stage-one2 \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-JA-StS-0.2-1.0-1.0-repair-remove-stage-one.log 



bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/BN/run_sts_qwen3_1.7b_sts-bn-language-important.sh
...
# bash /home/nfs05/liujx/Inference/scripts/temp.sh
# bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/run_sts_qwen3_1.7b-only-stage-two.sh
# bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/run_sts_qwen3_1.7b-remove-three.sh