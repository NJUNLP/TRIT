...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-remove-translation"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.task='sts-remove-translation' \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-remove-translation \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-JA/StS-0.2-1.0-1.0-repair-remove-translation \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-JA-StS-0.2-1.0-1.0-repair-remove-translation.log 

# bash /home/nfs05/liujx/Inference/scripts/temp.sh

bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/BN/run_sts_qwen3_1.7b_qalign-only-stage-one-bn.sh
bash /home/nfs05/liujx/Inference/scripts/temp.sh