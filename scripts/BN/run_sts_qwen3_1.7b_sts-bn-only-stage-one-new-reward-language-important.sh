...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-BN/StS-0.2-1.0-1.0-repair-bn-only-stage-one-language-important"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 data.train_files=/home/nfs05/liujx/GithubRepos/SvS-0918/data/math8k-ljx-sts-bn.parquet \
 data.val_files=/home/nfs05/liujx/GithubRepos/SvS-0918/data/math500_bn_question_bn_prompt_bn_begin.parquet \
 ...
 trainer.task='sts-only-stage-one' \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-bn-sts-only-stage-one-language-important \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-BN/StS-0.2-1.0-1.0-repair-bn-only-stage-one-language-important \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-BN-StS-0.2-1.0-1.0-repair-bn-only-stage-one-language-important.log 

# bash /home/nfs05/liujx/Inference/scripts/temp.sh


# bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/BN/run_sts_qwen3_1.7b_qalign-plus-remove-translation-bn.sh
