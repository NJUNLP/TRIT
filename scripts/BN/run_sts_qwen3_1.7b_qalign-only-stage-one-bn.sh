...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-BN/StS-0.2-1.0-1.0-repair-qalign-only-stage-one-bn"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-qalign-only-stage-one-bn \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-BN/StS-0.2-1.0-1.0-repair-qalign-only-stage-one-bn \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-BN-StS-0.2-1.0-1.0-repair-qalign-only-stage-one-bn.log 
...
bash /home/nfs05/liujx/GithubRepos/SvS-0918/scripts/BN/run_sts_qwen3_1.7b_qalign-plus-bn.sh