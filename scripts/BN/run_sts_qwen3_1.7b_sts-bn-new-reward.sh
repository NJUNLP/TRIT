...
export MATH_LJX_STRICT_LANGUAGE_REWARD_USE_MINUS=1
# export DEBUGGING_STS=True
export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
export USE_CONSISTENT_LANGUAGE_WEIGHT=True
export WANDB_MODE=offline
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-Qwen3-1.7B-BN/StS-0.2-1.0-1.0-repair-bn-new-reward"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-repair-bn-new-reward \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-Qwen3-1.7B-BN/StS-0.2-1.0-1.0-repair-bn-new-reward \
 trainer.total_epochs=5 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-BN-StS-0.2-1.0-1.0-repair-bn-new-reward.log 
