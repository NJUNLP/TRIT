...
export WANDB_DIR="/home/nfs05/liujx/GithubRepos/verl/wandb/MATH8K-DeepSeek-Distill-1D5B-JA/StS-0.2-1.0-1.0-4096-language-first"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
 ...
 trainer.experiment_name=StS-0.2-1.0-1.0-4096-language-first \
 trainer.default_local_dir=/home/nfs05/liujx/GithubRepos/verl/checkpoints/MATH8K-DeepSeek-Distill-1D5B-JA/StS-0.2-1.0-1.0-4096-language-first \
 trainer.total_epochs=10 2>&1 | tee /home/nfs05/liujx/GithubRepos/verl/logs/MATH8K-DeepSeek-Distill-1D5B-JA-StS-0.2-1.0-1.0-4096-language-first.log 
