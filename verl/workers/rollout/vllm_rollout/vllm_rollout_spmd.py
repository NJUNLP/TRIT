...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        is_translation = prompts.meta_info.get("translation", False)
        is_multilingual_reasoning = prompts.meta_info.get("multilingual_reasoning", False)
        if not do_sample:
            kwargs = {
                "best_of": 1,
                "top_p": 1.0,
            ...
            kwargs = {
                "top_p": prompts.meta_info.get("top_p", 0.9),
                "temperature": prompts.meta_info.get("temperature", 0.7),
                "n": prompts.meta_info.get("n", 1)
            }
            print(f">>> vllm_translation: top_p={kwargs['top_p']}, temperature={kwargs['temperature']}, n={kwargs['n']}")
        elif is_multilingual_reasoning:
            kwargs = {
                "top_p": prompts.meta_info.get("top_p", self.config.get("top_p", 1.0)),
                "temperature": prompts.meta_info.get("temperature", self.config.get("temperature", 1.0)),
                "n": prompts.meta_info.get("n", 1),
            }
            print(f">>> vllm_multilingual_reasoning: top_p={kwargs['top_p']}, temperature={kwargs['temperature']}, n={kwargs['n']}")
